...
@Validated
public class LLMFileDownloadController extends BaseFileDownloadController {

    public LLMFileDownloadController(FileStorageService fileStorageService, RedisTemplate<String, Object> redisTemplate) {

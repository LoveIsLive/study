...
public final class StoryboardSchemaPrompts {
    ...
    private static final String EXAMPLE_POINT_P_LABEL_BODY =
            "    {\n"
                    ...
                    + "          \"parameters\": {\"side\": \"up_right\", \"offset\": 0.25, \"clearance\": 0.08},\n"
                    + "          \"strength\": \"hard\",\n"
    ...
    public static final String MANIM_COMPANION_LABEL_EXAMPLE =
            "Companion label example:\n"
                    ...
                    + "\n"
                    + "Then include it as a scene patch beside its parent without placement because `label_for` derives its position from refs and parameters:\n"
                    + "{\n"
                    + "  \"id\": \"labelP\",\n"
                    + "  \"style\": {\n"
                    + "    \"color\": \"#FFFFFF\",\n"
